...
const Onboardingstep2diplomentScreen = props => {
  const { theme } = props;
    ...
    >
      <View style={styles(theme).View8dc796a9}>
        ...
        <View style={styles(theme).View74f59245}>
          <Text style={styles(theme).Textd70eb763}>{'Step 2'}</Text>

          <Text style={styles(theme).Textdf1f1e08}>{'Diplomatic info'}</Text>
        </View>
...
export default withTheme(Onboardingstep2diplomentScreen);
