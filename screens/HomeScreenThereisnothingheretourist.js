...
const HomeScreenThereisnothingheretourist = props => {
  const { theme } = props;
          ...
          <Touchable>
            <View style={styles(theme).Viewce068078}>
              <Icon
                ...
                color={theme.colors['Custom #14495c']}
              />
              <View style={styles(theme).Viewfc86b090}>
...
const styles = theme =>
  StyleSheet.create({
    ...
    Viewfc86b090: { marginLeft: 5, width: '70%' },
    screen: { backgroundColor: theme.colors['Custom Color'] },
  });

export default withTheme(HomeScreenThereisnothingheretourist);
