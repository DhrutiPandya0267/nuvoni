...
const TouristPassportinfostep2Screen = props => {
  const { theme } = props;
    ...
    >
      <View style={styles(theme).View8dc796a9}>
        ...
        <View style={styles(theme).View74f59245}>
          ...
          <Text style={styles(theme).Textdf1f1e08}>{'Passport info'}</Text>
        </View>
...
export default withTheme(TouristPassportinfostep2Screen);
